...
if __name__ == "__main__":
    ...
    # ---------------------------------------------------------------
    NUM_RUNS = 20
    BITSTREAM_LEN = 24   # number of payload bits per run
    ...
    for run in range(NUM_RUNS):
        ...
        # Encoding
        code_bits = rs_encode_bits(bitstream)
        ...
        # Decoding
        decoded_bits = rs_decode_bits(rec_bits, segment_bits)
